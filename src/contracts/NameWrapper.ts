...
export const NAME_WRAPPER_ABI = [
    ...
    'function registerAndWrapETH2LD(string label, address wrappedOwner, uint256 duration, address resolver, uint32 fuses, uint64 expiry) returns (uint256 registrarExpiry)',
    'function registrar() view returns (address)',
    'function renew(uint256 tokenId, uint256 duration, uint32 fuses, uint64 expiry) returns (uint256 expires)',
    ...
    'function setFuses(bytes32 node, uint32 fuses) returns (uint32)',
    ...
    'function upgrade(bytes32 parentNode, string label, address wrappedOwner, address resolver)',
    'function upgradeContract() view returns (address)',
    'function upgradeETH2LD(string label, address wrappedOwner, address resolver)',
    'function uri(uint256 tokenId) view returns (string)',
    'function userETH2LDs(address user) view returns (string[])',
    'function wrap(bytes name, address wrappedOwner, address resolver)',
    'function wrapETH2LD(string label, address wrappedOwner, uint32 fuses, uint64 expiry, address resolver) returns (uint64)'
];